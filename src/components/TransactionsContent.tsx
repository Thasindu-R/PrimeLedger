import { Download, ChevronUp, ChevronDown, Receipt, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center gap-2 border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors"
        >
          <Download size={15} />
      ...
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-4 mb-4">
        ...
        <div className="flex gap-3 mb-3">
          <input
            ...
            className="flex-1 px-4 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-gray-300"
          />
          <div className="flex gap-1 bg-gray-50 rounded-xl p-1">
            <button
              onClick={() => (filters.type ? resetFilters() : null)}
              className={`px-4 py-2 text-sm rounded-lg transition-all ${
                !filters.type ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
              All
            </button>
            <button
              ...
              className={`px-4 py-2 text-sm rounded-lg transition-all ${
                filters.type === 'income' ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
              Income
            </button>
            <button
              ...
              className={`px-4 py-2 text-sm rounded-lg transition-all ${
                filters.type === 'expense' ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
              Expense
            </button>
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`flex items-center gap-1 text-sm transition-colors ${
              isSortActive('date') ? 'text-green-600 font-medium' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Date
            {getSortIcon('date')}
          ...
          <button
            ...
            className={`flex items-center gap-1 text-sm transition-colors ${
              isSortActive('amount') ? 'text-green-600 font-medium' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Amount
            {getSortIcon('amount')}
          ...
          <button
            ...
            className={`flex items-center gap-1 text-sm transition-colors ${
              isSortActive('category') ? 'text-green-600 font-medium' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Category
          ...
          <button
            ...
            className={`flex items-center gap-1 text-sm transition-colors ${
              isSortActive('type') ? 'text-green-600 font-medium' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            Type
            {getSortIcon('type')}
